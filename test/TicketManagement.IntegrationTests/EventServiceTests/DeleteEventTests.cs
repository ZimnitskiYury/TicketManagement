...
namespace TicketManagement.IntegrationTests.EventServiceTests
{
    ...
    public class DeleteEventTests
    {
        ...
        [Test]
        public static void IsValid_WhenDeleteEventFailed_ShouldReturn0AffectedRows()
        {
            // Arrange
            ...
            // Act
            int rows = _eventService.Delete(test);
        ...
        [Test]
        public void IsValid_WhenDeleteEventSuccess_ShouldReturn1AffectedRows()
        {
            // Arrange
            var test = new EventData
            {
