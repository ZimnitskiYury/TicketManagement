...
{
    public class EditVenueViewModel : BindableBase, IDialogAware
    {
        private readonly IVenueApiService apiService;
        private DelegateCommand<string> _closeDialogCommand;

        public EditVenueViewModel(VenueApiService venueApi)
        {
            apiService = venueApi;
        }
        ...
        public string Title => "Edit Venue";
        ...
        protected virtual void CloseDialog(string parameter)
        {
            ...
            if (parameter?.ToLower() == "true")
            {
                ...
                _ = apiService.UpdateVenueAsync(venue).Result;
            }
